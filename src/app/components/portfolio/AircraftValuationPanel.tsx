...
export const valuationData: AircraftValuation[] = [
  {
    ...
    partOutComponents: [
      { name: "Airframe",     componentValue:  7_860_000, recoveryFactor: 0.72 },
      { name: "Engine #1",    componentValue:  7_360_000, recoveryFactor: 0.75 },
      { name: "Engine #2",    componentValue:  7_360_000, recoveryFactor: 0.75 },
      { name: "Landing Gear", componentValue:  1_780_000, recoveryFactor: 0.68 },
      { name: "APU",          componentValue:  1_040_000, recoveryFactor: 0.65 },
      { name: "Avionics",     componentValue:    790_000, recoveryFactor: 0.60 },
    ],
  },
  {
    msn: "41234",
    ...
    partOutComponents: [
      { name: "Airframe",     componentValue:  8_720_000, recoveryFactor: 0.70 },
      { name: "Engine #1",    componentValue:  7_960_000, recoveryFactor: 0.74 },
      { name: "Engine #2",    componentValue:  7_960_000, recoveryFactor: 0.74 },
      { name: "Landing Gear", componentValue:  1_920_000, recoveryFactor: 0.67 },
      { name: "APU",          componentValue:  1_130_000, recoveryFactor: 0.64 },
      { name: "Avionics",     componentValue:    850_000, recoveryFactor: 0.60 },
    ],
  },
  {
    msn: "62047",
    ...
    partOutComponents: [
      { name: "Airframe",     componentValue: 22_440_000, recoveryFactor: 0.74 },
      { name: "Engine #1",    componentValue: 26_680_000, recoveryFactor: 0.80 },
      { name: "Engine #2",    componentValue: 26_680_000, recoveryFactor: 0.80 },
      { name: "Landing Gear", componentValue:  5_100_000, recoveryFactor: 0.70 },
      { name: "APU",          componentValue:  2_550_000, recoveryFactor: 0.68 },
      { name: "Avionics",     componentValue:  1_940_000, recoveryFactor: 0.62 },
    ],
  },
  {
    msn: "1728",
    ...
    partOutComponents: [
      { name: "Airframe",     componentValue:  8_590_000, recoveryFactor: 0.71 },
      { name: "Engine #1",    componentValue:  8_350_000, recoveryFactor: 0.74 },
      { name: "Engine #2",    componentValue:  8_350_000, recoveryFactor: 0.74 },
      { name: "Landing Gear", componentValue:  2_150_000, recoveryFactor: 0.68 },
      { name: "APU",          componentValue:  1_170_000, recoveryFactor: 0.65 },
      { name: "Avionics",     componentValue:    880_000, recoveryFactor: 0.60 },
    ],
  },
  {
    msn: "67892",
    ...
    partOutComponents: [
      { name: "Airframe",     componentValue: 12_830_000, recoveryFactor: 0.73 },
      { name: "Engine #1",    componentValue: 13_580_000, recoveryFactor: 0.78 },
      { name: "Engine #2",    componentValue: 13_580_000, recoveryFactor: 0.78 },
      { name: "Landing Gear", componentValue:  3_020_000, recoveryFactor: 0.69 },
      { name: "APU",          componentValue:  1_510_000, recoveryFactor: 0.66 },
      { name: "Avionics",     componentValue:  1_080_000, recoveryFactor: 0.62 },
    ],
  },
  {
    msn: "0378",
    ...
    partOutComponents: [
      { name: "Airframe",     componentValue: 19_080_000, recoveryFactor: 0.74 },
      { name: "Engine #1",    componentValue: 20_590_000, recoveryFactor: 0.80 },
      { name: "Engine #2",    componentValue: 20_590_000, recoveryFactor: 0.80 },
      { name: "Landing Gear", componentValue:  4_520_000, recoveryFactor: 0.70 },
      { name: "APU",          componentValue:  2_260_000, recoveryFactor: 0.68 },
      { name: "Avionics",     componentValue:  1_510_000, recoveryFactor: 0.62 },
    ],
  },
];
